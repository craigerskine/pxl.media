<template>
  <nav class="pb-10">
    <ul class="flex flex-wrap items-center justify-center space-x-5">
      ...
      <li v-else-if="currentPage === 2"><nuxt-link :to="pagePath" class="transition hover:(text-white) focus:(text-white)"><span class="sr-only">Previous</span> <i class="fal fa-fw fa-angle-left fa-2x"></i></nuxt-link></li>
